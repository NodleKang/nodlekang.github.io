...
본 포스트는 2025년 1월에 SAP 사업 방향 전환을 학습한 내용입니다.
...
- **SAP NetWeaver**
  - SAP의 전통적인 온프레미스 애플리케이션 플랫폼으로, ERP, CRM, SCM 등 다양한 SAP 애플리케이션을 실행하는 데 사용되었습니다.
  - 현재는 SAP BTP로 대체되고 있으며, 클라우드 중심의 플랫폼으로 전환 중입니다.

- **SAP ECC (ERP Central Component)**
  - SAP의 전통적인 ERP 솔루션으로, 재무, 물류, 인사 등 기업의 핵심 비즈니스 프로세스를 관리하는 데 사용되었습니다.
  - SAP S/4HANA로 대체되고 있으며, 2027년까지 SAP ECC에 대한 지원이 종료될 예정입니다.

- **SAP HANA**
  - SAP의 인메모리 데이터베이스로, 데이터를 메모리에 저장하여 빠른 데이터 처리와 실시간 분석을 가능하게 합니다.
  - SAP S/4HANA와 같은 최신 SAP 솔루션의 핵심 데이터베이스로 사용됩니다.

- **SAP S/4HANA**
  - SAP의 차세대 ERP 솔루션으로, SAP HANA 데이터베이스를 기반으로 설계되었습니다.
  - 간소화된 데이터 모델, 실시간 데이터 처리, 사용자 친화적인 Fiori UI를 제공합니다.
  - 클라우드와 온프레미스 모두에서 사용할 수 있습니다.

- **SAP BTP (Business Technology Platform)**
  - SAP의 클라우드 기반 기술 플랫폼으로, 데이터 관리, 애플리케이션 개발, 통합, 확장성을 제공합니다.
  - 고객이 SAP 및 비SAP 시스템을 통합하고, 새로운 애플리케이션을 개발하며, 데이터를 활용한 인사이트를 얻을 수 있도록 지원합니다.

- **SAP PCE (Private Cloud Edition)**
  - SAP S/4HANA를 클라우드 환경에서 사용할 수 있도록 지원하는 솔루션입니다.
  - 기존 온프레미스 고객이 클라우드로 전환할 수 있는 경로를 제공합니다.
  - 클라우드의 유연성과 온프레미스의 제어성을 결합한 하이브리드 솔루션입니다.
...
- **SAP Fiori**
  - SAP의 현대적인 UX 프레임워크로, 단순하고 직관적인 사용자 경험을 제공합니다.
  - 역할 기반(Role-Based), 반응형(Responsive), 일관성(Consistency)을 핵심 원칙으로 합니다.

- **SAPUI5**
  - SAP Fiori 애플리케이션을 개발하기 위한 프론트엔드 프레임워크입니다.
  - HTML5, CSS3, JavaScript를 기반으로 하며, 반응형 디자인과 다양한 UI 컴포넌트를 제공합니다.

- **OpenUI5**
  - SAPUI5의 오픈소스 버전으로, SAP 외부에서도 자유롭게 사용할 수 있습니다.

- **SAP Fiori Elements**
- 템플릿 기반의 개발 도구로, OData 서비스를 활용하여 표준화된 Fiori 애플리케이션을 빠르게 개발할 수 있습니다.

- **SAP Build Apps**
  - Low-Code/No-Code 플랫폼으로, 비개발자도 쉽게 SAP Fiori 스타일의 애플리케이션을 만들 수 있습니다.

- **SAP Fiori Launchpad**
  - SAP Fiori 애플리케이션에 접근할 수 있는 중앙화된 대시보드입니다. 역할 기반으로 사용자에게 필요한 애플리케이션만 표시합니다.

- **SAP CoPilot**
  - SAP의 디지털 어시스턴트로, Fiori 환경에서 사용자와 상호작용하며 작업을 지원합니다.
...
- ABAP의 현대화된 개발 모델로, 클라우드 환경에서 RESTful API를 통해 SAP 시스템과 상호작용할 수 있도록 지원합니다.
- SAP S/4HANA Cloud와 같은 클라우드 솔루션에서 ABAP를 활용할 수 있게 합니다.

2. **SAP BTP (Business Technology Platform)**

- SAP의 클라우드 플랫폼으로, 다양한 언어(Node.js, Java, Python, Go 등)를 지원하여 확장 애플리케이션을 개발할 수 있습니다.
- SAP BTP는 클라우드 네이티브 개발, 데이터 관리, 통합, AI/ML 기능을 제공합니다.

3. **SAP Cloud Application Programming Model (CAP)**

- SAP BTP에서 클라우드 애플리케이션을 개발하기 위한 프레임워크로, Node.js와 Java를 지원합니다.
- CAP는 OData 서비스와 통합되어 데이터 모델링과 API 개발을 간소화합니다.

4. **SAP Graph API**

RESTful API를 통해 SAP 데이터를 다양한 언어(JavaScript, Python, Java 등)로 쉽게 활용할 수 있도록 지원합니다.

5. **SAP Build Apps**

Low-Code/No-Code 플랫폼으로, 프로그래밍 언어 없이도 SAP 시스템과 통합된 애플리케이션을 개발할 수 있습니다.
